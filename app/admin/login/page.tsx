  ...
  return (
    <div className="flex min-h-[80vh] items-center justify-center">
      <div className="glass-panel w-full max-w-sm p-8">
        <div className="mb-6 flex h-11 w-11 items-center justify-center rounded-full bg-volt-500/15 text-volt-400">
          <Lock size={18} />
        </div>
        ...
        {!configured && (
          <p className="mt-5 rounded-lg border border-flare-500/40 bg-flare-500/10 p-3 font-body text-xs leading-relaxed text-flare-400">
        ...
        <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
          <div>
            ...
            <input
              ...
              className="w-full rounded-lg border border-white/15 bg-white/[0.03] px-4 py-2.5 font-body text-sm text-bone-50 outline-none focus:border-volt-500/60"
              placeholder="you@plus380.com"
            />
          </div>
          <div>
            <label className="mb-1.5 block font-mono text-[0.65rem] uppercase tracking-widest text-bone-500">
          ...
          {error && <p className="font-body text-xs text-flare-400">{error}</p>}
